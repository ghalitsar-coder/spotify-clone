...
import LikeButton from "@/components/Search/SearchContent/LikeButton";
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 h-full">
      <div className="flex w-full justify-start">
        <div className="flex items-center gap-x-4">
          <MediaItem data={song} playing onClick={() => {}} />
     ...
     "
      ...
      <div className="hidden h-full md:flex justify-center items-ceqnter w-full max-w-[722px] gap-x-6">
        <AiFillStepBackward
          onClick={() => {}}
          size={30}
